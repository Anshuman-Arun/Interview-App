...
const KNOWN_EVENT_TYPE_MAP = {
  ...
  QUANT_TRADING_SCENARIO_INITIALIZED: true,
  QUANT_TRADING_ACTION_ACCEPTED: true,
  QUANT_TRADING_ROUND_RESOLVED: true,
  QUANT_TRADING_SCENARIO_COMPLETED: true,
  ...
  VISION_EVIDENCE_BRIDGE_DECIDED: true,
  VISION_EVIDENCE_BRIDGE_COMPLETED: true,
