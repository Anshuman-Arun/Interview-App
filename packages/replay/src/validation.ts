...
type ActiveSessionRequiredEventType =
  typeof ACTIVE_SESSION_REQUIRED_EVENT_TYPE_VALUES[number];

const POST_TERMINAL_ALLOWED_EVENT_TYPE_VALUES = [
  "SESSION_STARTED",
  "PROBLEM_PRESENTED",
  "UTTERANCE_DISCARDED",
...
type ClassifiedTerminalEventType =
  | ActiveSessionRequiredEventType
...
const terminalEventPolicyIsExhaustive:
  ...
  = true;
void terminalEventPolicyIsExhaustive;
