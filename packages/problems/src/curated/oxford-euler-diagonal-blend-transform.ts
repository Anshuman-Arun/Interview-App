...
export const oxfordEulerDiagonalBlendTransformSpec = makeEulerCandidateSpec({
  ...
  "givenInformation":["You may use the distance formula and ordinary coordinate algebra.","A line through the origin may be represented by y=mx, but remember that this misses the vertical line.","In the extension T_a, the parameter a is real."],
