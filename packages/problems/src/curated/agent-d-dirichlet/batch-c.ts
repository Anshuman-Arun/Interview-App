...
export const oxfordDDiscreteMaximumPrincipleSpec: CuratedProblemSpec = {
  ...
  oxfordAdaptive: makeDirichletAdaptive({
    ...
    skillEvidence: [evidence("small-case-exploration", "supporting"), evidence("strategic-simplification", "primary"), evidence("proof-construction", "primary"), evidence("generalization", "supporting"), evidence("precision-checking", "supporting")],
...
export const oxfordDSpanningTreeExchangeSpec: CuratedProblemSpec = {
  ...
  oxfordAdaptive: makeDirichletAdaptive({
    ...
    skillEvidence: [evidence("small-case-exploration", "supporting"), evidence("proof-construction", "primary"), evidence("invariants", "supporting"), evidence("transfer", "primary"), evidence("precision-checking", "supporting")],
...
export const oxfordDStableBinaryWordsSpec: CuratedProblemSpec = {
  ...
  oxfordAdaptive: makeDirichletAdaptive({
    ...
    skillEvidence: [evidence("small-case-exploration", "primary"), evidence("representation-switching", "supporting"), evidence("proof-construction", "primary"), evidence("generalization", "primary"), evidence("precision-checking", "supporting")],
    difficulty: { entry: "introductory", core: "standard", ceiling: "strong" },
    novelty: "high",
    abstraction: "low",
