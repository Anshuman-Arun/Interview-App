...
export const oxfordDBalancingTransfersSpec: CuratedProblemSpec = {
  ...
  extensions: [
    { id: "path-local-counterexample", prompt: "For adjacent-only moves on three boxes, analyze the start (0,3,1) and show two different terminal multisets are possible." },
