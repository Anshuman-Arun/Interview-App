...
export const oxfordDPrimeDivisorThreeCyclesSpec: CuratedProblemSpec = {
  ...
  oxfordAdaptive: makeDirichletAdaptive({
    ...
    skillEvidence: [evidence("representation-switching", "primary"), evidence("proof-construction", "primary"), evidence("case-analysis", "supporting"), evidence("transfer", "supporting")],
...
export const oxfordDSlidingWindowParitySpec: CuratedProblemSpec = {
  ...
  oxfordAdaptive: makeDirichletAdaptive({
    ...
    skillEvidence: [evidence("representation-switching", "primary"), evidence("pattern-recognition", "primary"), evidence("proof-construction", "primary"), evidence("generalization", "supporting")],
...
export const oxfordDLaminarFamilySpec: CuratedProblemSpec = {
  ...
  oxfordAdaptive: makeDirichletAdaptive({
    ...
    skillEvidence: [evidence("small-case-exploration", "supporting"), evidence("representation-switching", "primary"), evidence("proof-construction", "primary"), evidence("precision-checking", "supporting")],
    difficulty: { entry: "introductory-plus", core: "standard", ceiling: "strong" },
    novelty: "moderate",
    abstraction: "moderate",
...
export const oxfordDMidpointClosedResiduesSpec: CuratedProblemSpec = {
  ...
  oxfordAdaptive: makeDirichletAdaptive({
    ...
    skillEvidence: [evidence("small-case-exploration", "supporting"), evidence("abstraction", "primary"), evidence("proof-construction", "primary"), evidence("generalization", "primary")],
    difficulty: { entry: "introductory-plus", core: "standard", ceiling: "strong" },
    novelty: "moderate",
    abstraction: "high",
    introducesNewDefinition: true,
