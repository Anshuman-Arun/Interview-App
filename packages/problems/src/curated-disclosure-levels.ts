...
export const CURATED_DISCLOSURE_LEVELS: Readonly<Record<string, ReviewedLevels>> = Object.freeze(
  ...
  "oxford-cantor-absolute-quadratic-crossings": reviewedLevels({ 1: 2, 2: 3, 3: 4, 4: 3, 5: 5 }),
  "oxford-cantor-cubic-divided-difference": reviewedLevels({ 1: 3, 2: 4, 3: 5, 4: 5, 5: 5 }),
  "oxford-cantor-cubic-two-thresholds": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-cantor-exponential-rotating-line": reviewedLevels({ 1: 2, 2: 3, 3: 4, 4: 5, 5: 5 }),
  "oxford-cantor-integral-sign-landscape": reviewedLevels({ 1: 2, 2: 3, 3: 3, 4: 4, 5: 5 }),
  "oxford-cantor-mobius-involution": reviewedLevels({ 1: 4, 2: 3, 3: 4, 4: 5, 5: 5 }),
  "oxford-cantor-mobius-recurrence": reviewedLevels({ 1: 1, 2: 3, 3: 5, 4: 5, 5: 5 }),
  "oxford-cantor-moving-integral-window": reviewedLevels({ 1: 2, 2: 1, 3: 4, 4: 4, 5: 5 }),
  "oxford-cantor-moving-v-envelope": reviewedLevels({ 1: 2, 2: 3, 3: 4, 4: 5, 5: 5 }),
  ...
  "oxford-cantor-reciprocal-paired-inputs": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 4, 5: 5 }),
  "oxford-cantor-reciprocal-root-parabolas": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-cantor-shifted-cubic-intersections": reviewedLevels({ 1: 1, 2: 3, 3: 5, 4: 5, 5: 5 }),
  "oxford-cantor-squared-error-recurrence": reviewedLevels({ 1: 2, 2: 3, 3: 4, 4: 5, 5: 5 }),
  "oxford-cantor-three-cycle-map": reviewedLevels({ 1: 2, 2: 1, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-balancing-transfers": reviewedLevels({ 1: 1, 2: 2, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-cube-twist-equivalence": reviewedLevels({ 1: 1, 2: 3, 3: 4, 4: 5, 5: 5 }),
  ...
  "oxford-d-three-reversal-permutations": reviewedLevels({ 1: 1, 2: 2, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-triple-flip-circle": reviewedLevels({ 1: 1, 2: 3, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-weighted-cycle-readings": reviewedLevels({ 1: 1, 2: 2, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-box-diagonal-bisector": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-circle-sweep": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-cooling-data-model": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-corner-balanced-tables": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-diagonal-blend-transform": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-kiosk-grid-model": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-periodic-queue-model": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-quadrilateral-balance": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-random-chord-midpoint": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-random-halving-interval": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-self-averaging-sets": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-tank-gauge-model": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-triangle-midpoint-cycle": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
