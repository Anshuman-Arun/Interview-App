...
export const CURATED_DISCLOSURE_LEVELS: Readonly<Record<string, ReviewedLevels>> = Object.freeze(
  ...
  "oxford-euler-difference-closed-sets": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-kiosk-grid-model": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-locally-balanced-labels": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  ...
  "oxford-euler-random-adjacent-consecutives": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  ...
  "oxford-euler-random-subset-blocks": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-rectangle-area-table": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-self-averaging-sets": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
  "oxford-euler-stop-on-change": reviewedLevels({ 1: 2, 2: 4, 3: 4, 4: 5, 5: 5 }),
