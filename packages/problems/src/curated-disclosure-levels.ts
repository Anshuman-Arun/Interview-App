...
export const CURATED_DISCLOSURE_LEVELS: Readonly<Record<string, ReviewedLevels>> = Object.freeze(
  ...
  "oxford-d-directed-flow-decomposition": reviewedLevels({ 1: 2, 2: 3, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-discrete-maximum-principle": reviewedLevels({ 1: 1, 2: 2, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-divisor-step-geometry": reviewedLevels({ 1: 1, 2: 2, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-finite-map-cycles": reviewedLevels({ 1: 1, 2: 2, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-gcd-descent-network": reviewedLevels({ 1: 1, 2: 2, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-idempotent-maps": reviewedLevels({ 1: 1, 2: 2, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-laminar-family": reviewedLevels({ 1: 1, 2: 2, 3: 4, 4: 5, 5: 5 }),
  ...
  "oxford-d-orientation-parities": reviewedLevels({ 1: 2, 2: 2, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-prime-divisor-three-cycles": reviewedLevels({ 1: 2, 2: 3, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-sliding-window-parity": reviewedLevels({ 1: 1, 2: 3, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-spanning-tree-exchange": reviewedLevels({ 1: 1, 2: 3, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-stable-binary-words": reviewedLevels({ 1: 1, 2: 2, 3: 4, 4: 5, 5: 5 }),
  "oxford-d-switching-cuts": reviewedLevels({ 1: 1, 2: 3, 3: 4, 4: 5, 5: 5 }),
