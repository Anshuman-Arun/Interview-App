...
if (oxfordCantorFamilies.length !== 20 || oxfordCantorReviewEntries.length !== 20) {
  throw new Error("Agent C — Cantor Wave 2 portfolio must contain exactly 20 candidate families");
}
