...
export class AuthoritativeBoardSyncCoordinator {
  ...
  /**
   * Wait until every mutation already admitted to this coordinator has reached
   * a terminal acknowledgement. Pause/resume uses this before reading board
   * authority again so an in-flight pointer-up cannot race a stale snapshot.
   */
