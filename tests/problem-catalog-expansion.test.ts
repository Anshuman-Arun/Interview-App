...
describe("curated problem bank", () => {
  ...
  it("compiles all 38 authored fixtures to five protected disclosures without assuming stage equals severity", () => {
    ...
    expect(curatedEntries).toHaveLength(38);
  ...
  it("exposes expert-review fixtures only through the isolated review tooling surface", () => {
    ...
    expect(reviewProblemIds).toHaveLength(19);
    ...
    expect(reviewProblemIds.filter((id) => id.startsWith("oxford-cantor-"))).toHaveLength(17);
  ...
  it("keeps expert-review fixtures explicit, documented, and absent from default lookup", () => {
    ...
    expect(reviewIds).toHaveLength(19);
